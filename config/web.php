...
$config = [
    ...
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => 't966mrjdw1GyV0JU1P8H9t83dW2deizo',
        ],
        'cache' => [
    ...
    'as beforeRequest' => [
        ...
        'rules' => [
            [
                'allow' => true,
                'actions' => ['login', 'captcha', 'error', 'qr', 'signup', 'cek-kegiatan', 'cek-rekening', 'unggah-kegiatan', 'result-kegiatan', 'unggah-rekening', 'result-rekening'],
            ],
            [
                'allow' => true,
                'roles' => ['@'],
