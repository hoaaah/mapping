    ...
    <div id="ajaxCrudDatatable">
        <?= GridView::widget([
            ...
            'rowOptions' => function ($model, $key, $index, $grid) {
                ...
                if ($klasifikasiLama) {
                    if ($klasifikasiLama->kd_rek_1 == $model->kd_rek_1 && $klasifikasiLama->kd_rek_2 == $model->kd_rek_2 && $klasifikasiLama->kd_rek_3 == $model->kd_rek_3 && $klasifikasiLama->kd_rek_4 == $model->kd_rek_4 && $klasifikasiLama->kd_rek_5 == $model->kd_rek_5) return ['class' => GridView::TYPE_DEFAULT];
                }
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Ref Rek5s listing',
                ...
                '<div class="row"><div class="col-md-3">' .
                    ...
                    $form->field($searchModel, 'kd_ujung')->widget(MaskedInput::class, [
                        'options' => ['placeholder' => '3 Digit Terakhir'],
                        'mask' => '9[9].9[9].9[9]'
                    ])->label(false) .
