...
/**
 * Rek3Controller implements the CRUD actions for RefRek3 model.
 */
class Rek3Controller extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        if (($model = RefRek3::findOne($id)) !== null) {
            return $model;
        } else {
